...
{
    public class ControllerType8053 : ControllerTypeBase
    {
        /// <summary>
        /// 日志
        /// </summary>
        ...
        private List<DeviceInfo8053> lstDeviceInfo;
        ...
        public ControllerType8053(SerialComManager serialManager, IProtocolDriver protocolDriver)
            : base(serialManager, protocolDriver)
        {
            base.ControllerModel = new Model.ControllerModel(ControllerType.NT8053);
        ...
        /// 器件信息集合
        /// </summary>
        public List<DeviceInfo8053> DeviceInfoList
        {
            get
            {
                ...
                {
                    lstDeviceInfo = new List<DeviceInfo8053>();
                }
        ...
        public override void ReceiveDeviceInfo()
        {
            ...
            IEqualityComparer<Model.DeviceInfo8053> c = new DeviceCompare();
            Model.DeviceInfo8053 deviceInfo = ParsePackageCC(receivedData);
        ...
        class DeviceCompare : IEqualityComparer<DeviceInfo8053>
        {
            public bool Equals(DeviceInfo8053 x, DeviceInfo8053 y)
            {
            ...
            public int GetHashCode(DeviceInfo8053 obj)
            {
        ...
        private byte[] AssemblePackageBB(Model.DeviceInfo8053 deviceInfo)
        {
            Model.DeviceInfo8053 singleDevInfo = deviceInfo;
        ...
        /// <returns></returns>
        private List<byte[]> AssemblePackageBB(List<Model.DeviceInfo8053> deviceInfo)
        {
            List<byte[]> lstSendData = new List<byte[]>();
            foreach (Model.DeviceInfo8053 singleDevInfo in deviceInfo)
            {
                byte[] sendData = new byte[54];
                sendData[0] = 0xAA;
                sendData[1] = 0x55;
        ...
        /// <returns></returns>
        private Model.DeviceInfo8053 ParsePackageCC(byte[] devicePackage)
        {

            ControllerModel cModel = new ControllerModel(2, "8053", ControllerType.NT8053, 3);
            ...
            DeviceInfo8053 deviceInfo = new DeviceInfo8053();
