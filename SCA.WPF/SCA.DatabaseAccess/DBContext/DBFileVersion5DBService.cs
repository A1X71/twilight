...
*
* Author     : William
* Create Date: 2017/7/17 13:42:58
* FileName   : DBFileVersion5Service
* Description:版本5数据文件操作服务
* Version：V1
* ===============================
*/
namespace SCA.DatabaseAccess.DBContext
{
    /// <summary>
    /// 版本5数据文件操作服务:
    /// 与版本4相比,“文件配置”表中增加“器件长度”
    /// </summary>
    public class DBFileVersion5DBService:DBFileVersionBaseService,IDBFileVersionService
    {
        ...
        public DBFileVersion5DBService(string dataSource, ILogRecorder logger, IFileService fileService)
        {
