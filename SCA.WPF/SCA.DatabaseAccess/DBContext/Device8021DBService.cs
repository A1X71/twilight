...
{
    class Device8021DBService:IDeviceDBServiceTest
    {
        
        private IDBFileVersionService _dbFileVersionService;


        public Device8021DBService(IDBFileVersionService dbFileVersionService)
        {
        ...
        public bool DeleteAllDevicesByControllerID(int id)
        {
            ...
            if (_dbFileVersionService.DeleteAllDevicesByControllerIDForControllerType8021(id) > 0)
                return true;
            else
                return false;
        }
        ...
        public bool DeleteDeviceByID(int id)
        {
            ...
            if (_dbFileVersionService.DeleteDeviceByIDForControllerType8021(id) > 0)
                return true;
            else
                return false;
        }
        ...
        public int GetMaxID()
        {
            ...
            return _dbFileVersionService.GetMaxDeviceIDForControllerType8021();
        }
    }
}
