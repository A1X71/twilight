...
namespace SCA.DatabaseAccess.DBContext
{
    class Device8003DBService : IDeviceDBServiceTest
    {
        ...
        public bool DeleteAllDevicesByControllerID(int id)
        {
            ...
            if (_dbFileVersionService.DeleteAllDevicesByControllerIDForControllerType8003(id) > 0)
                return true;
            else
                return false;
        }
        ...
        public bool DeleteDeviceByID(int id)
        {
            ...
            if (_dbFileVersionService.DeleteDeviceByIDForControllerType8003(id) > 0)
                return true;
            else
                return false;
        }
        ...
        public int GetMaxID()
        {
            ...
            return _dbFileVersionService.GetMaxDeviceIDForControllerType8003();
        }
    }
}
