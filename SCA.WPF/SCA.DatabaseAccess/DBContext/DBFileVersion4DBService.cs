...
*
* Author     : William
* Create Date: 2017/7/17 13:42:44
* FileName   : DBFileVersion4Service
* Description:
* Version：V1
* ===============================
*/
namespace SCA.DatabaseAccess.DBContext
{
    ...
    /// /// 版本4数据文件操作服务
    /// </summary>
    public class DBFileVersion4DBService : DBFileVersionBaseService,IDBFileVersionService
    {
        ...
        #region  Do not need to implement
        ...
        //{
        //    StringBuilder sbQuerySQL = new StringBuilder("select 文件版本,控制器类型,协议版本,位置 from 文件配置 left join 位置信息 on 文件配置.文件版本=位置信息.位置;");
        //    DataTable dtFile = _databaseService.GetDataTableBySQL(sbQuerySQL);            
        ...
        public int AddDeviceForControllerType8053(DeviceInfo8001 deviceInfo)
        {
            throw new NotImplementedException();
        }
