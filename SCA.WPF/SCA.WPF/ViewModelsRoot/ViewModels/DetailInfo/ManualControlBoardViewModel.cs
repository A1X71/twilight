...
namespace SCA.WPF.ViewModelsRoot.ViewModels.DetailInfo
{
    ...
    public class EditableManualControlBoard : ManualControlBoard, IEditableObject, IDataErrorInfo
    {
    ...
    public class ManualControlBoardViewModel : PropertyChangedBase
    {
        ...
        private Visibility _createManualControlBoardVisibility = Visibility.Hidden;
        ...
        private SCA.WPF.CreateManualControlBoard.CreateManualControlBoardViewModel _createVM; 
        ...
        public void AddMoreRecordExecute()
        {
         //   SCA.WPF.Infrastructure.EventMediator.Unregister("ManualControlBoardAddMoreLines", ((SCA.WPF.ViewModelsRoot.ViewModels.DetailInfo.ManualControlBoardViewModel)this.DataContext).AddMoreLines);
            ...
            _createVM = new CreateManualControlBoard.CreateManualControlBoardViewModel();
            _createVM.TheController = TheController;
            CreateVM = _createVM;
